    ...
    <footer>
      <div className="px-4 xl:px-56 md:pt-[100px] pt-[80px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="group-icon">
              <div className="box-icons flex">
                <div className="images">
                  <img src="https://themesflat.co/html/dreamhomehtml/assets/images/icon/footer-icon-1.png" alt="images" />
                </div>
                <div className="content">
                  <div className="title-icon">You need a house</div>
                  <p className="text-[13px]">Tell us your needs, we will give you thousands of suggestions for the dream home.</p>
                </div>
              </div>
              <div className="button-footer center flex items-center justify-center">
          ...
          <div>
            <div className="group-icon group-2">
              <div className="box-icons flex">
                <div className="images">
                  <img src="https://themesflat.co/html/dreamhomehtml/assets/images/icon/footer-icon-2.png" alt="images" />
                </div>
                <div className="content">
                  <div className="title-icon">Sell your house</div>
                  <p className="text-[13px]">We will connect you to thousands of people who need to buy a home.</p>
                </div>
              </div>
              <div className="button-footer center flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4 mb-4">
          <div>
            <div className="widget widget-info text-white">
              <h3 className='mb-5 lg:mb-6 text-lg leading-4 font-semibold'>Office Address</h3>
              <p className="sub-title">Head office:</p>
              <h5 className="mb-4 font-semibold text-sm leading-5">2118 Thornridge Cir. Syracuse, Connecticut 35624</h5>
              <p className="sub-title">Branch:</p>
              <p className="text-1">3891 Ranchview Dr. Richardson, California 62639</p>
              <p className="text-1">3517 W. Gray St. Utica, Pennsylvania 57867</p>
            </div>
          </div>
          <div>
            <div className="widget widget-menu style-2 text-white">
              <h3 className='mb-5 lg:mb-6 text-lg leading-4 font-semibold'>Contact Seller</h3>
              <div className="box-icon flex items-center justify-between">
                <div className="img-group flex align-center">
                  <div className="images flex-none">
                    <img src="https://themesflat.co/html/dreamhomehtml/assets/images/author/author-footer.jpg" alt="images" />
                  </div>
                  <div className="content">
                    <p className='text-[#8E8E93] text-sm font-light'>Darrell Steward</p>
                    <a href="tel:012345678"><h5 className='text-sm font-semibold pt-1'>(405) 555-0128</h5></a>
                  </div>
                </div>
                <a href="#" className="button-author text-center">
                  <ChevronRightOutlinedIcon className='w-4 h-4 mb-[2px]' />
                </a>
              </div>
              <div className="box-icon flex align-center">
                ...
                <div className="content">
                  <p className='text-[#8E8E93] text-sm font-light'>Hotline:</p>
                  <a href="tel:012345678"><h5 className='text-sm font-semibold pt-1'>(201) 555-0124</h5></a>
                </div>
              </div>
              <div className="box-icon flex align-center">
                <div className="icon flex-none">
                ...
                <div className="content">
                  <p className='text-[#8E8E93] text-sm font-light'>Email:</p>
                  <a href="mailto:Realestatecp@gmail.com"><h5 className='text-sm font-light pt-1'>Realestatecp@gmail.com</h5></a>
                </div>
              </div>
            </div>
          </div>
          <div>
            <div className="widget widget-menu style-3 ">
              <h3 className='mb-5 lg:mb-6 text-lg leading-4 font-semibold text-white'>Our Company</h3>
          ...
          <div>
            <div className="widget widget-menu widget-form">
              <h3 className='mb-5 lg:mb-6 text-lg leading-4 font-semibold text-white'>Newsletter</h3>
              <form method="post" className="comment-form form-submit" action="#" acceptCharset="utf-8">
                <p className="mb-4 text-[#F1FAEE] text-[13px]">Sign up to receive the latest articles</p>
                <div className="text-wrap clearfix">
                  <fieldset className="email-wrap style-text">
                    <input type="email" className="tb-my-input" name="email" placeholder="Your email address" required fdprocessedid="puzurh" />
                  </fieldset>
                </div>
                <button name="submit" type="submit" className="button btn-submit-comment btn-1 btn-8" fdprocessedid="t8fdc">
                  <span>Sign Up</span>
                  <ArrowForwardOutlinedIcon className='icon' />
                </button>
                <label className="flex">
                  <input id="remember" type="checkbox" defaultValue className="w-4 h-4 border rounded focus:ring-3 bg-amber-700 border-amber-600 focus:ring-amber-600 ring-offset-amber-800 focus:ring-offset-amber-800"/>
                  <label className="ml-2 text-[#F1FAEE] text-xs leading-5">I have read and agree to the terms &amp; conditions</label>
                </label>
              </form>
            </div>
          </div>
